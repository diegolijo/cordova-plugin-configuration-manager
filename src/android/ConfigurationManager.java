...
public class ConfigurationManager extends CordovaPlugin {
        ...
        private void canScheduleExactAlarms(CallbackContext callbackContext) {
                ...
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.S) {
                        AlarmManager alarmManager = (AlarmManager) cordova.getActivity().getBaseContext()
        ...
        private boolean getAndroidSettings(CallbackContext callbackContext) {
                ...
                String errorMessage1 = "Please provide one of the following values as a parameter or any other value from android.settings";
        ...
        // AlarmClock.ACTION_SHOW_ALARMS -> configuracion de alarma <uses-permission
        // android:name="com.android.alarm.permission.SET_ALARM" />
        // Settings.ACTION_AIRPLANE_MODE_SETTINGS -> modo avión
        // Settings.ACTION_ACCESSIBILITY_SETTINGS -> accesivilidad
        // Settings.ACTION_MANAGE_DEFAULT_APPS_SETTINGS -> aplicaciones predeterminadas
        // en Android
        ...
        // Settings.ACTION_REQUEST_MANAGE_MEDIA -> Aplicacion con permiso gestion
        // multimedia

        // ************** necesitan paquete de app **************
        // Settings.ACTION_APP_NOTIFICATION_SETTINGS -> (Extra) notificaciones
        // Settings.ACTION_APP_NOTIFICATION_BUBBLE_SETTINGS -> (Extra) burbujas de
        // notificaciones
        // Settings.ACTION_APPLICATION_DETAILS_SETTINGS -> (URI) config general de la
        // app
        // Settings.ACTION_MANAGE_UNKNOWN_APP_SOURCES -> (URI) permisos instalar apps
        // fuentes desconocidas
        // Settings.ACTION_APP_OPEN_BY_DEFAULT_SETTINGS -> (URI) Abrir enlaces
        // permitidos
        // Settings.ACTION_MANAGE_APP_ALL_FILES_ACCESS_PERMISSION -> (URI) Acceso a
        // todos los archivos necestita <uses-permission
